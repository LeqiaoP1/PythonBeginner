...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
    ...
    while remained_hand:
        ...
        user_input = raw_input("another word to score or '.' to quit >")
        if (user_input != '.'): # continue with another word
            if (is_valid_word(user_input, remained_hand, word_list)):
                ...
                remained_hand = update_hand(remained_hand, user_input)        
                print '** Well done! Add score: ', new_score
                print '** Now total score is: ', final_score  
            else:
